...
const DBNAME = 'nom_de_la_base'; // Nom de la base de données
const DBUSER = 'nom_user'; // Utilisateur de la base de données
const DBPASS = 'pass_user'; // Mot de passe de l'utilisateur
